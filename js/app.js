(() => {
    ...
    const navigation = document.querySelector(".products__navigation");
    const buttonLine = document.getElementById("line");
    ...
    buttonLine.addEventListener("click", (() => {
        ...
        if (buttonLine.classList.contains("active")) {
    ...
    window.addEventListener("resize", (() => {
        ...
        if (width < 1350) {
            ...
            if (!buttonGrid.classList.contains("active")) products.classList.remove("grid");
